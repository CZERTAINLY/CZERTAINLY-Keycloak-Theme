...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "header">
        ...
        <link href="${url.resourcesPath}/img/favicon.svg" rel="icon"/>
        <script>
    ...
    <#elseif section = "form">
        <div>
            <img class="logo" src="${url.resourcesPath}/img/czertainly_logo.svg" alt="CZERTAINLY">
        </div>
        ...
        <div>
            <p class="copyright">&copy; CZERTAINLY s.r.o.</p>
        </div>
    </#if>
